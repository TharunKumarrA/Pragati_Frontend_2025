...
const ToastTitle = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Title
    ref={ref}
    className={cn("text-sm font-semibold [&+div]:text-xs [font-family:var(--font-poppins)]", className)}
    {...props}
  />
));
...
const ToastDescription = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-xs opacity-90 [font-family:var(--font-poppins)]", className)}
    {...props}
  />
));
