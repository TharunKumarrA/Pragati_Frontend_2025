...
function OlympicConclave() {
  return (
    <div className="flex flex-col items-center px-4 md:px-16 pt-8 pb-8 bg-[linear-gradient(180deg,#FFF 0%,#E8D096 100%)] w-full h-screen overflow-hidden">
      ...
      {/* Events Button */}
      <button
        className="mt-4 px-8 md:px-12 py-2 md:py-3 text-xl md:text-3xl tracking-wider text-center text-black border-2 border-black bg-[linear-gradient(90deg,#FACC15,#E8D096)] rounded-full hover:bg-opacity-80 [font-family:var(--font-chicavenue)]"
        tabIndex={0}
      >
        EVENTS
      </button>
