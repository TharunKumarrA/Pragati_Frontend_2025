  ...
  return (
    <div className="relative h-screen flex flex-col cursor-default">
      ...
      >
        ...
        <div className="mt-10 px-3 py-2 bg-white/5 backdrop-blur-sm border border-white rounded-xl transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-lg hover:shadow-[#f3e5c0]/50 hover:ring-2 hover:ring-[#f3e5c0]/50">
