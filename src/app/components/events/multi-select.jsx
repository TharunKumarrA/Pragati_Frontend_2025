...
import { Button } from "@/app/components/events/button";
import { Badge } from "@/app/components/events/badge";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/app/components/events/popover";
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  CommandList,
  CommandSeparator,
} from "@/app/components/events/command";
      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-[90%] md:w-[14rem] p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              className
            )}
          >
